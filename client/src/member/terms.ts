...
export const TERMS_DATA: Record<string, TermContent> = {
  service: {
    title: '이용약관',
    body: 
    `
      ...
      <strong>제24조(재판권 및 준거법)</strong>
        ...
        부칙(시행일) 이 약관은 2026년 1월 1일부터 시행합니다.
      `
  },
  privacy: {
    title: '개인정보 수집·이용 동의',
    body: `
    <p class="table-title">개인정보 수집·이용 (필수)</p>
      <table class="terms-table">
        ...
        <tbody>
          <tr>
            <td rowspan="3">개인정보 보호법 제15조 (개인정보의 수집ㆍ이용)</td>
            <td>회원가입</td>
            <td>회원정보 등록</td>
            <td>이름, 아이디, 비밀번호, 이메일, 주소지, 성별, 휴대전화, 생년월일</td>
            <td rowspan="2">회원 탈퇴 시까지</td>
          </tr>
          <tr>
            <td>서비스제공</td>
            <td>맞춤형 정보추천 서비스 제공</td>
            <td>배송지역, 성별, 연령대, 서비스 이용 및 방문이력</td>
          </tr>
          <tr>
            <td>부정 이용 방지</td>
            <td>부정 이용자 이력 관리</td>
            <td>부정 이용자의 이름, 아이디, 휴대폰번호, 이메일, 주소, 부정 이용 기록</td>
            <td>회원 탈퇴 후 1년</td>
          </tr>
        </tbody>
      </table>
      <p class="table-notice">* 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있으며, 동의 거부 시 서비스 이용이 제한될 수 있습니다.</p>
    `
  },
  marketing: {
    title: '마케팅 광고 활용 동의',
    body: `
      <p class="table-title">개인정보 수집·이용 (선택)</p>
      <table class="terms-table">
        <thead>
          <tr>
            <th>구분</th>
      ...
      <p class="table-notice">* 동의하지 않으셔도 쇼핑몰 서비스는 이용하실 수 있습니다.</p>
    `
  }
};